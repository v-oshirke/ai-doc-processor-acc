...
def get_blob_from_container(container_name):
    # sort by upload time 
    credential = DefaultAzureCredential()
    blob_service_client = BlobServiceClient.from_connection_string(os.getenv("BLOB_ENDPOINT"))
...
def generate_prompt(analysis_result, raw_content):
    ...
    prompt = (
        ...
        f"{', '.join(entities)}\n"
        "And the full text of the patient call log:\n"
        f"{content}\n"
